...
var Tooltip = function(container, datum, translation){
    ...
    tooltipContainer
        ...
        .style('top', (d3.event.pageY + translation) + 'px')
        .transition(200)
        .style('opacity', 1)
        .style('display','block');
